...
sheets <- c("ENGE_1993a2004", "ENGE_2004a2011", "ENGE_2012a2016", "ENGE_2017a2023")
...
ENGE_2012a2023 <- merge(x = ENGE_2012a2016,
                        y = ENGE_2017a2023,
                        all = T)

#Quito las que ya no uso
rm(ENGE_1993a2004,ENGE_2004a2011,ENGE_2012a2016,ENGE_2017a2023)
...
base.ENGE_1993a2023.bind <- bind_rows(list(ENGE_1993a2011,ENGE_2012a2023), .id = "id")
```

```{r duplicates}
#ME fijo si hay observaciones repetidas
base.ENGE_1993a2023.bind %>%
...
write.xlsx(base.ENGE_1993a2023.bind,"Output/base.ENGE_1993a2023_wider.id.xlsx")

#Pivoteo
base.ENGE_1993a2023.bind <- base.ENGE_1993a2023.bind %>% 
...
write.xlsx(base.ENGE_1993a2023.bind,"Output/base.ENGE_1993a2023_longer.id.xlsx")
...
```{r}
df_enge = base.ENGE_1993a2023.bind 
head(df_enge)
```
```{r}
